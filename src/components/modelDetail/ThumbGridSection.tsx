  ...
  return (
    <div className="rounded-2xl border border-zinc-200 bg-white shadow-sm">
      <div className="flex items-center justify-between gap-3 border-b border-zinc-200 px-5 py-4">
        ...
        <div className="text-xs text-zinc-500">{t('model.photosCount', { count: images.length })}</div>
      </div>
      {list.length === 0 ? (
        <div className="px-5 py-10 text-center text-sm text-zinc-600">{t('common.noImage')}</div>
      ) : (
