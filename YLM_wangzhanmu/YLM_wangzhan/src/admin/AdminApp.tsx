...
type Tab = "content-publish" | "knowledge-base" | "material-asset" | "customer-inquiries" | "permission-approval" | "system-config";
...
export default function AdminApp() {
  ...
  useEffect(() => {
    async function loadProfile() {
      ...
      console.log("Loading admin profile for user:", session.user.id);
      ...
      if (!error && data) {
        ...
        console.log("Using fallback for default super admin");
        setProfile({
          id: session.user.id,
