...
type SiteDisplayTab = "carousel" | "brands" | "announcements" | "layout" | "country-sales";

export default function AdminSiteDisplay() {
  const [tab, setTab] = useState<SiteDisplayTab>("carousel");
  ...
  return (
    <div className={pageCardCls() + " p-8"}>
      ...
      <div className="mb-8">
        <div className="flex flex-wrap gap-2 border-b border-zinc-200 pb-3">
          <button
            ...
            className={subTabCls(tab === "carousel")}
          >
            首页轮播图管理
          </button>
          <button
      ...
      <div className="space-y-6">
        {tab === "carousel" ? (
          <div className="rounded-2xl border border-zinc-200 bg-gradient-to-br from-zinc-50 to-white p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="text-xl font-semibold text-zinc-900">首页轮播图管理</h4>
            </div>
        ...
        {tab === "country-sales" ? <AdminCountrySales /> : null}
      </div>
    </div>
  );
}
