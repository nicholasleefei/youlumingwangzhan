...
export default function Globe(props: Props) {
  ...
  useEffect(() => {
    ...
    function render() {
      ...
      g.addColorStop(0.55, "rgba(15, 30, 60, 0.25)");
      ...
      ctx.beginPath();
      path({ type: "Sphere" } as any);
      ctx.strokeStyle = "rgba(22, 93, 255, 0.4)";
      ctx.lineWidth = 2;
      ctx.stroke();
  ...
  }, [bordersMesh, colors, countriesFeature, interactive, maxScale, minScale, rotateSpeed, sortedSales]);
  ...
  return (
    <div className={props.className}>
      <div className="relative h-full w-full">
        <canvas ref={canvasRef} className="h-full w-full border-none outline-none" />
        {displayedCountry ? (
